...
resource "aws_ecs_task_definition" "hedwig_console" {
  container_definitions    = templatefile(
                                       "task_definitions/hedwig_console_fargate.json",
                                       {
                                           ...
                                           database_host="hedwig-test.cqtkdkbdf9yu.ap-southeast-1.rds.amazonaws.com",
                                           ...
                                           redis_endpoint = data.terraform_remote_state.hedwig_api_group.outputs.redis_endpoint,
